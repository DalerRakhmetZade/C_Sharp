...
namespace MegaChallengeWar
{
    public class Game
    {
        ...
        public string Play()
        {
            ...
            int round = 0;
            while (_player1.Card.Count !=0 && _player2.Card.Count != 0)
            {
        ...
        {
            string result = "";
            if (_player1.Card.Count > _player2.Card.Count)
            ...
            result += "<br/><span style ='color:red; font-weight:bolder;'>Player 1:" + _player1.Card.Count + "</span> <br/><span style ='color:blue; font-weight:bolder;'> Player 2:" + _player2.Card.Count + "</span>";
            return result;
        }
    }
}